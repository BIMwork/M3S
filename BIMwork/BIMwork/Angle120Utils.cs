...
namespace BIMwork
{
    public static class Angle120Utils
    {
        ...
        public static TargetPoint handleTextNotes120OXY(ref XYZ coord, ref XYZ anchor, ref XYZ elbow, ref XYZ end)
        {
            TargetPoint targetPoint = null;
            // update
        ...
        // tag
        // oxz
        private static void calcNewElbowTagOXZ(ref XYZ tagHeadPosition,
            ref XYZ end, ref XYZ elbow)
        {
            // oxz -> oxy
            // ox -> ox
            // oz -> oy
        ...
        public static TargetPoint handleTag120OXZ(ref XYZ anchor, ref XYZ elbow, ref XYZ end)
        {
        ...
        // oyz
        private static void calcNewElbowTagOYZ(ref XYZ tagHeadPosition,
            ref XYZ end, ref XYZ elbow)
        {
            // oyz -> oxy
            // ox -> oy
        ...
        public static TargetPoint handleTag120OYZ(ref XYZ anchor, ref XYZ elbow, ref XYZ end)
        {
            TargetPoint targetPoint = null;
        ...
        // oxy
        private static void calcNewElbowTagOXY(ref XYZ tagHeadPosition,
            ref XYZ end, ref XYZ elbow)
        {
            /* double absDy = Math.Abs(elbow.Y - end.Y);
             double lenX = absDy / Math.Tan(Convert.ToDouble(ANGLE_TARGET) * Math.PI / 180.0);
        ...
        public static TargetPoint handleTag120OXY(ref XYZ anchor, ref XYZ elbow, ref XYZ end)
        {
            TargetPoint targetPoint = null;
